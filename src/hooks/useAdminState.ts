...
export const useAdminState = () => {
  ...
  // Navigation state - updated to include edit-requests and projects tabs
  const [activeTab, setActiveTab] = useState<'properties' | 'requests' | 'edit-requests' | 'deletion-requests' | 'archive' | 'content' | 'chats' | 'contact' | 'team' | 'projects'>('properties');
