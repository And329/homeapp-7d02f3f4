-- Update the approve_property_request function to include contact information
...
BEGIN
  ...
  -- Insert into properties table with ALL relevant fields including contact information
  INSERT INTO public.properties (
    title, description, price, location, latitude, longitude,
    bedrooms, bathrooms, type, property_type, emirate, area,
    ...
    request_record.amenities, request_record.images, request_record.videos,
