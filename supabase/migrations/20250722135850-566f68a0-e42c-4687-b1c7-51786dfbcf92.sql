-- Update the approve_property_request function to include year_built, parking, and admin_notes
...
BEGIN
  ...
  INSERT INTO public.properties (
    ...
    COALESCE((request_record.videos::jsonb->>'year_built')::integer, NULL),
    COALESCE((request_record.videos::jsonb->>'parking')::integer, NULL),
